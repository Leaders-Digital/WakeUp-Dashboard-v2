...
const AddVariantModal = ({ productId ,getProduct}) => {  
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_URL_PRODUCTION}api/product/add-variant`, formData);
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h1 className="modal-title fs-5" id="exampleModalLabel">Ajouter des variants</h1>
          ...
          <div className="modal-body" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-around" }}>
              {/* Logo Section */}
              <div style={{ display: "flex", justifyContent: "center", position: "relative", width: "30%", flexDirection: "column", gap: "20px" }}>
                <img
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={handleSubmit}>Confirmer</button>
          </div>
        </div>
      </div>
    </div>
